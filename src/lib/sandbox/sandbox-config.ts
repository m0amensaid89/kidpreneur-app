...
export const LESSON_SANDBOX: Record<string, SandboxConfig> = {
  l1: {
    ...
    placeholderEn: 'A golden retriever astronaut floating in space, cartoon style, colorful...',
    placeholderAr: 'كلب ذهبي يطير في الفضاء، أسلوب كارتون، ملون...',
  ...
  l2: {
    ...
    placeholderEn: 'A cyberpunk dragon with neon wings, dark city background, cinematic lighting...',
    placeholderAr: 'تنين سايبربانك بأجنحة نيون، خلفية مدينة مظلمة، إضاءة سينمائية...',
    ...
    outputType: 'image',
    toolName: 'Midjourney',
    toolDeepLink: 'https://leonardo.ai',
  },
  l3: {
    mode: 'IMAGE_GEN',
  ...
  l5: {
    ...
    quackyTipEn: 'Describe it like you are texting a friend. Conversational prompts work great!',
    quackyTipAr: 'اوصفها زي ما بتكتب لصاحبك. الكلام الطبيعي بيشتغل ممتاز!',
    outputType: 'image',
    toolName: 'DALL-E via ChatGPT',
    toolDeepLink: 'https://www.bing.com/images/create',
  },
  l6: {
    mode: 'IMAGE_GEN',
    promptLabel: { en: 'Describe your image or new scene', ar: 'اوصف الصورة أو المشهد الجديد' },
  ...
  l7: {
    ...
    quackyTipEn: 'Include: who uses it, what problem it solves, and main features (3 max)',
  ...
  l8: {
    ...
    placeholderEn: 'Logo for QUACKY — a duck with bold yellow text, minimal, modern style...',
    placeholderAr: 'لوجو لـ كواكي — بطة مع نص أصفر غامق، بسيط، أسلوب عصري...',
  ...
  l10: {
    ...
    quackyTipEn: 'Push back on the answers: But what if that is wrong? What am I missing?',
    quackyTipAr: 'تحدى الإجابات: بس إيه لو ده غلط؟ إيه اللي مش شايفه؟',
    outputType: 'text',
    toolName: 'Claude',
    toolDeepLink: 'https://claude.ai',
  },
  l11: { mode: 'VOICE_GEN', promptLabel: { en: 'Type what you want to narrate', ar: 'اكتب اللي عايز تسجله' }, placeholderEn: 'Hey everyone, welcome to my podcast about AI tools for kids...', placeholderAr: 'أهلاً يا جماعة، أهلاً ببودكاستي عن أدوات الذكاء الاصطناعي للأطفال...', quackyTipEn: 'Keep it conversational. Record like you are talking to a friend.', quackyTipAr: 'خليها محادثة. سجل زي ما بتتكلم مع صاحبك.', outputType: 'audio', toolName: 'Descript', toolDeepLink: 'https://www.descript.com' },
  l12: { mode: 'VOICE_GEN', promptLabel: { en: 'Write your script to narrate', ar: 'اكتب السكريبت اللي عايز ينتج صوت منه' }, placeholderEn: 'In a world where kids build businesses with AI, one duck changed everything...', placeholderAr: 'في عالم حيث الأطفال يبنون مشاريع بالذكاء الاصطناعي، بطة واحدة غيرت كل حاجة...', quackyTipEn: 'Try different voice speeds — slower for educational, faster for exciting content!', quackyTipAr: 'جرب سرعات صوت مختلفة — أبطأ للتعليمي، أسرع للمحتوى المثير!', outputType: 'audio', toolName: 'ElevenLabs', toolDeepLink: 'https://elevenlabs.io' },
  l13: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open HeyGen to create your avatar', ar: 'افتح HeyGen عشان تعمل أفاتارك' }, placeholderEn: '', placeholderAr: '', quackyTipEn: '1. Upload your photo. 2. Write your script. 3. Pick a voice. 4. Generate!', quackyTipAr: '١. ارفع صورتك. ٢. اكتب السكريبت. ٣. اختار صوت. ٤. ولد!', outputType: 'none', toolName: 'HeyGen', toolDeepLink: 'https://www.heygen.com' },
  l14: { mode: 'TEXT_GEN', promptLabel: { en: 'Write your video script', ar: 'اكتب سكريبت الفيديو بتاعك' }, placeholderEn: 'Write a 60-second video script about how I learned to use AI tools this week...', placeholderAr: 'اكتب سكريبت فيديو 60 ثانية عن إزاي اتعلمت أدوات الذكاء الاصطناعي الأسبوع ده...', quackyTipEn: 'Structure: Hook (5s) then Story (40s) then Call to action (15s)', quackyTipAr: 'الهيكل: هوك (٥ ثواني) ثم القصة (٤٠ ثانية) ثم دعوة للعمل (١٥ ثانية)', outputType: 'text', toolName: 'Fliki', toolDeepLink: 'https://fliki.ai' },
  l15: { mode: 'TEXT_GEN', promptLabel: { en: 'Write your script scene', ar: 'اكتب مشهد السكريبت بتاعك' }, placeholderEn: 'INT. BEDROOM - DAY. A 13-year-old sits at a computer, staring at a blank screen...', placeholderAr: 'داخلي. غرفة نوم - نهار. طفل عنده 13 سنة جالس عند الكمبيوتر، بيحدق في شاشة فاضية...', quackyTipEn: 'Format: Location. Time. Then action. Then dialogue. Simple!', quackyTipAr: 'الشكل: المكان. الوقت. ثم الحدث. ثم الحوار. بسيط!', outputType: 'text', toolName: 'Script AI', toolDeepLink: 'https://scriptai.com' },
  ...
  l19: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open CapCut to edit your video', ar: 'افتح CapCut عشان تعدل فيديوك' }, placeholderEn: '', placeholderAr: '', quackyTipEn: 'Hook formula: Start with the most interesting moment. Never start from the beginning!', quackyTipAr: 'فورمولا الهوك: ابدأ بأكتر لحظة مثيرة. ما تبدأش من الأول أبداً!', outputType: 'none', toolName: 'CapCut', toolDeepLink: 'https://www.capcut.com' },
  l20: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open Submagic to add captions', ar: 'افتح Submagic عشان تضيف كابشنز' }, placeholderEn: '', placeholderAr: '', quackyTipEn: 'Yellow highlighted keywords get 34% more watch time. Always highlight the power word!', quackyTipAr: 'الكلمات المظلّلة باللون الأصفر بتاخد ٣٤٪ وقت مشاهدة أكتر. دايماً ضلل الكلمة القوية!', outputType: 'none', toolName: 'Submagic', toolDeepLink: 'https://www.capcut.com' },
  l21: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open Later to schedule your content', ar: 'افتح Later عشان تجدول محتواك' }, placeholderEn: '', placeholderAr: '', quackyTipEn: 'Best posting times: Tuesday-Thursday, 11am or 7pm in your audience timezone.', quackyTipAr: 'أحسن أوقات النشر: الثلاثاء-الخميس، ١١ صباحاً أو ٧ مساءً في توقيت جمهورك.', outputType: 'none', toolName: 'Later', toolDeepLink: 'https://later.com' },
  l22: { mode: 'TEXT_GEN', promptLabel: { en: 'Analyze a competitor or topic', ar: 'حلل منافس أو موضوع' }, placeholderEn: 'Analyze the content strategy of KidPreneur — an AI learning platform for kids aged 8-15...', placeholderAr: 'حلل استراتيجية محتوى KidPreneur — منصة تعليم الذكاء الاصطناعي للأطفال من ٨-١٥ سنة...', quackyTipEn: 'Ask: What are they doing well? What gaps can I fill? What would I do differently?', quackyTipAr: 'اسأل: إيه اللي بيعملوه كويس؟ إيه الفجوات اللي أقدر أملأها؟ إيه اللي كنت هأعمله بشكل مختلف؟', outputType: 'text', toolName: 'Predis.ai', toolDeepLink: 'https://predis.ai' },
  l23: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open Notion AI to build your workspace', ar: 'افتح Notion AI عشان تبني مساحة عملك' }, placeholderEn: '', placeholderAr: '', quackyTipEn: 'Start with 3 pages: Projects, Ideas, Goals. Link them. That is your second brain!', quackyTipAr: 'ابدأ بـ٣ صفحات: مشاريع، أفكار، أهداف. اربطهم ببعض. ده هو عقلك الثاني!', outputType: 'none', toolName: 'Notion AI', toolDeepLink: 'https://notion.so' },
  ...
  l25: { mode: 'GUIDE_ONLY', promptLabel: { en: 'Open Superhuman to process your inbox', ar: 'افتح Superhuman عشان تعالج إيميلاتك' }, placeholderEn: '', placeholderAr: '', quackyTipEn: 'Keyboard shortcut rule: E = archive, R = reply, K = move up. Master these 3 first.', quackyTipAr: 'قاعدة الاختصارات: E = أرشفة، R = رد، K = تحرك لأعلى. أتقن الثلاثة دول أول.', outputType: 'none', toolName: 'Superhuman', toolDeepLink: 'https://mail.google.com' },
  l26: { mode: 'TEXT_GEN', promptLabel: { en: 'Capture and connect your ideas', ar: 'سجل أفكارك وربطها' }, placeholderEn: 'I have 3 ideas: AI stickers business, YouTube about AI tools, AI tutoring service. Connect them.', placeholderAr: 'عندي ٣ أفكار: بيزنس ستيكرز ذكاء اصطناعي، يوتيوب عن أدوات الذكاء الاصطناعي، خدمة مذاكرة. ربطهم.', quackyTipEn: 'Ask AI: What pattern do you see in these ideas? What core skill connects them?', quackyTipAr: 'اسأل الذكاء الاصطناعي: إيه النمط اللي شايفه في الأفكار دي؟ إيه المهارة الأساسية اللي بتربطهم؟', outputType: 'text', toolName: 'Mem.ai', toolDeepLink: 'https://mem.ai' },
